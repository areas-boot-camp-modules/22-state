...
export default function StudentList() {
  ...
  // Holds temp value in input while typing until it is submitted.
        ...
        <>
          <section className="student-list">
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => {
                          ...
                          // Removes a student from the state "students" array.
                          return dispatch({
                            type: REMOVE_STUDENT,
                            payload: student.id,
                          });
            ...
            <div className="add-major">
              ...
              {/* local (it uses useState inside this component) */}
              <input
                value={newMajorName}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  // Adds a major to the state "majors" array.
                  return dispatch({
                    type: ADD_MAJOR,
